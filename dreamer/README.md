...
[![Stars](https://img.shields.io/github/stars/yourusername/Dreamer?style=social)](https://github.com/yourusername/Dreamer)
...
- Additional ComfyUI workflow variants
- New expression/style preset packs
- Performance optimizations
- Testing on different hardware (MPS/CPU/ROCm)
...
- [ComfyUI](https://github.com/comfyanonymous/ComfyUI) — the backbone of this pipeline
- [IPAdapter](https://github.com/tencent-ailab/IP-Adapter) — identity conditioning
- [InstantID](https://github.com/InstantID/InstantID) — tight face binding
- [ControlNet](https://github.com/lllyasviel/ControlNet) — structural conditioning
